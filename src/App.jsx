    ...
    <div className="overflow-x-hidden border-t-2 w-screen min-h-[100vh] bg-zinc-800 flex items-center flex-col">
      ...
      >
        <input
          ...
          className="px-5 py-2 text-yellow-100 outline-none w-[85%] rounded-xl bg-zinc-700"
        />
        <button className="outline-none text-4xl font-extrabold flex justify-center items-center w-[5vmax] h-[5vmax] ml-3 rounded-full bg-orange-600">
